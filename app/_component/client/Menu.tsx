...
export function Menu({ children, open, onClose }: { children: ReactNode; open: boolean; onClose: () => void }) {
  ...
  return (
    <ul
      ...
      className={`absolute z-40 max-h-44 overflow-y-auto overflow-x-hidden rounded-md bg-gradient-to-br from-gray-100 from-30% to-gray-50 to-70% py-2 shadow-inner dark:from-gray-900 dark:to-gray-800 dark:shadow-gray-600 ${open ? 'block' : 'hidden'}`}
      style={{
